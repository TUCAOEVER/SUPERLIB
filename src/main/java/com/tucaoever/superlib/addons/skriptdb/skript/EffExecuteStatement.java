...
import com.tucaoever.superlib.addons.skriptdb.SkriptUtil;
...
public class EffExecuteStatement extends Effect {
    private static final ExecutorService threadPool = Executors.newFixedThreadPool(SUPERLIB.getInstance().getConfig().getInt("thread-pool-size", 10));
    ...
    protected void execute(Event e) {
        ...
        if (Bukkit.isPrimaryThread()) {
            ...
            sql.whenComplete((res, err) -> {
                ...
                if (!quickly) {
                    Bukkit.getScheduler().runTask(SUPERLIB.getInstance(), () -> {
    ...
    private Object executeStatement(DataSource ds, String baseVariable, Pair<String, List<Object>> query) {
        ...
        try (Connection conn = ds.getConnection();
            ...
            if (baseVariable != null) {
                ...
                if (hasResultSet) {
                    CachedRowSet crs = SUPERLIB.getRowSetFactory().createCachedRowSet();
