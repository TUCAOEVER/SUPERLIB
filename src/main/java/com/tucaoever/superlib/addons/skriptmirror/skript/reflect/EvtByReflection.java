...
import com.tucaoever.superlib.addons.skriptmirror.WrappedEvent;
  ...
  public void register(Trigger t) {
    for (Class<? extends Event> eventClass : classes) {
      ...
      Bukkit.getPluginManager()
          .registerEvent(eventClass, listener, priority, executor, SUPERLIB.getInstance(), ignoreCancelled);
    }
  }
