...
import com.tucaoever.superlib.addons.skriptmirror.skript.custom.condition.CustomConditionSection;
import com.tucaoever.superlib.addons.skriptmirror.skript.custom.effect.CustomEffectSection;
import com.tucaoever.superlib.addons.skriptmirror.skript.custom.event.CustomEventSection;
import com.tucaoever.superlib.addons.skriptmirror.skript.custom.expression.CustomExpressionSection;
import com.tucaoever.superlib.addons.skriptmirror.util.SkriptReflection;
...
public class PreloadListener implements Listener {
  ...
  static {
    Bukkit.getPluginManager().registerEvents(new PreloadListener(), SUPERLIB.getInstance());
    ...
    if (SUPERLIB.getInstance().getConfig().getBoolean("enable-preloading")) {
      try {
