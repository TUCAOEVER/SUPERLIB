...
public class EffSetBlockNBT extends Effect {
    ...
    private static final boolean BLOCK_DATA = Skript.classExists("org.bukkit.block.data.BlockData") && Skript.classExists("ch.njol.skript.expressions.ExprBlockData");
